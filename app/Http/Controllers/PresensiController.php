...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // PERBAIKAN GPS (tanpa ubah struktur)
        $radius = floor($jarak["meters"]);

        $image = $request->image;

        if(!$lokasi){
            echo "error|GPS not detected|in";
            return;
        }

        // VALIDASI RADIUS (buffer GPS)
        if ($radius > $lok_kantor->radius) {
            echo "error|Sorry, you are outside the permitted office radius!|";
            return;
        }
        ...
        if(!$presensi){
            ...
            echo "success|Check In Success|in";
            return;
        }
        ...
        if($presensi->jam_out == null){
            ...
            echo "success|Check Out Success|out";
            return;
        }

        echo "error|You already checked out today!|out";
    }
    ...
    public function updateprofile(Request $request)
{
    ...
    if ($request->hasFile('foto')) {
        ...
        // folder tujuan storage
        $folderPath = "uploads/karyawan/";

        // SIMPAN KE storage/app/public/uploads/karyawan
    ...
    public function storeizin(Request $request)
    {
        ...
        if($simpan){
            return redirect('/presensi/izin')->with(['success'=>'Success! Data has been saved']);
        }else{
            return redirect('/presensi/izin')->with(['error'=>'Failed to save data']);
        }
    ...
    public function cetaklaporan(Request $request){
        ...
        $presensi = DB::table('presensi')
            ...
            if (isset($_POST['exportexcel'])) {
                ...
                // Mendefisinikan nama file ekspor "hasil-export.xls"
    ...
    public function cetakrekap(Request $request)
    {
        ...
        if (isset($_POST['exportexcel'])) {
            ...
            header("Content-type: application/vnd-ms-excel");
            // Mendefisinikan nama file ekspor "hasil-export.xls"
            header("Content-Disposition: attachment; filename=Rekapitulasi Presensi Karyawan $time.xls");
        }
    ...
    public function approveizinsakit(Request $request)
    {
        ...
        if($update){
            ...
            return Redirect::back()->with(['warning'=>'Failed to update data!']);
        }
    }

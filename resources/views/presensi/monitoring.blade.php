                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="tanggal" name="tanggal" value="{{ date("Y-m-d") }}" class="form-control" placeholder="Attendance Date" autocomplete="off">
                              </div>
                            </div>
                        </div>
                        <div class="row">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">User Presence Location</h5>
